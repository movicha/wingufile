...
#define WINGUFILE_RECVBLOCK_PROC(obj)                  (G_TYPE_CHECK_INSTANCE_CAST ((obj), WINGUFILE_TYPE_RECVBLOCK_PROC, SeafileRecvblockProc))
#define WINGUFILE_IS_RECVBLOCK_PROC(obj)               (G_TYPE_CHECK_INSTANCE_TYPE ((obj), WINGUFILE_TYPE_RECVBLOCK_PROC))
#define WINGUFILE_RECVBLOCK_PROC_CLASS(klass)          (G_TYPE_CHECK_CLASS_CAST ((klass), WINGUFILE_TYPE_RECVBLOCK_PROC, SeafileRecvblockProcClass))
#define IS_WINGUFILE_RECVBLOCK_PROC_CLASS(klass)       (G_TYPE_CHECK_CLASS_TYPE ((klass), WINGUFILE_TYPE_RECVBLOCK_PROC))
#define WINGUFILE_RECVBLOCK_PROC_GET_CLASS(obj)        (G_TYPE_INSTANCE_GET_CLASS ((obj), WINGUFILE_TYPE_RECVBLOCK_PROC, SeafileRecvblockProcClass))
