...
#define WINGUFILE_RECVBRANCH_PROC(obj)                  (G_TYPE_CHECK_INSTANCE_CAST ((obj), WINGUFILE_TYPE_RECVBRANCH_PROC, SeafileRecvbranchProc))
#define WINGUFILE_IS_RECVBRANCH_PROC(obj)               (G_TYPE_CHECK_INSTANCE_TYPE ((obj), WINGUFILE_TYPE_RECVBRANCH_PROC))
#define WINGUFILE_RECVBRANCH_PROC_CLASS(klass)          (G_TYPE_CHECK_CLASS_CAST ((klass), WINGUFILE_TYPE_RECVBRANCH_PROC, SeafileRecvbranchProcClass))
#define IS_WINGUFILE_RECVBRANCH_PROC_CLASS(klass)       (G_TYPE_CHECK_CLASS_TYPE ((klass), WINGUFILE_TYPE_RECVBRANCH_PROC))
#define WINGUFILE_RECVBRANCH_PROC_GET_CLASS(obj)        (G_TYPE_INSTANCE_GET_CLASS ((obj), WINGUFILE_TYPE_RECVBRANCH_PROC, SeafileRecvbranchProcClass))
