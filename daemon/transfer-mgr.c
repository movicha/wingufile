...
static const char *transfer_task_error_strs[] = {
    ...
    "Transfer protocol outdated. You need to upgrade wingufile.",
...
static void register_processors (CcnetClient *client)
{
    ccnet_proc_factory_register_processor (client->proc_factory,
                                           "wingufile-check-tx-v2",
                                           WINGUFILE_TYPE_CHECK_TX_V2_PROC);

    ccnet_proc_factory_register_processor (client->proc_factory,
                                           "wingufile-check-tx-v3",
                                           WINGUFILE_TYPE_CHECK_TX_V3_PROC);

    ccnet_proc_factory_register_processor (client->proc_factory,
                                           "wingufile-getcommit",
                                           WINGUFILE_TYPE_GETCOMMIT_PROC);

    ccnet_proc_factory_register_processor (client->proc_factory,
                                           "wingufile-sendcommit",
                                           WINGUFILE_TYPE_SENDCOMMIT_PROC);

    ccnet_proc_factory_register_processor (client->proc_factory,
                                           "wingufile-getblock",
                                           WINGUFILE_TYPE_GETBLOCK_PROC);

    ccnet_proc_factory_register_processor (client->proc_factory,
                                           "wingufile-getblock-v2",
                                           WINGUFILE_TYPE_GETBLOCK_V2_PROC);

    ccnet_proc_factory_register_processor (client->proc_factory,
                                           "wingufile-sendblock",
                                           WINGUFILE_TYPE_SENDBLOCK_PROC);

    ccnet_proc_factory_register_processor (client->proc_factory,
                                           "wingufile-sendblock-v2",
                                           WINGUFILE_TYPE_SENDBLOCK_V2_PROC);

    ccnet_proc_factory_register_processor (client->proc_factory,
                                           "wingufile-sendfs",
                                           WINGUFILE_TYPE_SENDFS_PROC);

    ccnet_proc_factory_register_processor (client->proc_factory,
                                           "wingufile-getfs",
                                           WINGUFILE_TYPE_GETFS_PROC);

    ccnet_proc_factory_register_processor (client->proc_factory,
                                           "wingufile-sendbranch",
                                           WINGUFILE_TYPE_SENDBRANCH_PROC);

    ccnet_proc_factory_register_processor (client->proc_factory,
                                           "wingufile-getcs",
                                           WINGUFILE_TYPE_GETCS_PROC);

    ccnet_proc_factory_register_processor (client->proc_factory,
                                           "wingufile-getcommit-v2",
                                           WINGUFILE_TYPE_GETCOMMIT_V2_PROC);

    ccnet_proc_factory_register_processor (client->proc_factory,
                                           "wingufile-sendcommit-v2",
                                           WINGUFILE_TYPE_SENDCOMMIT_V2_PROC);
    ccnet_proc_factory_register_processor (client->proc_factory,
                                           "wingufile-sendcommit-v3",
                                           WINGUFILE_TYPE_SENDCOMMIT_V3_PROC);
    ccnet_proc_factory_register_processor (client->proc_factory,
                                           "wingufile-checkbl",
                                           WINGUFILE_TYPE_CHECKBL_PROC);
    ccnet_proc_factory_register_processor (client->proc_factory,
                                           "wingufile-getcs-v2",
                                           WINGUFILE_TYPE_GETCS_V2_PROC);
}
                                    ...
                                    GError **error)
{
    ...
    if (!repo_id || !from_branch || !to_branch || !token) {
        g_set_error (error, WINGUFILE_DOMAIN, SEAF_ERR_BAD_ARGS, "Empty argument(s)");
        return NULL;
    }
    ...
    if (is_duplicate_task (manager, repo_id)) {
        g_set_error (error, WINGUFILE_DOMAIN, SEAF_ERR_GENERAL, "Task is already in progress");
        return NULL;
    }
                                       ...
                                       guint n_procs)
{
    ...
    if (!wingufile_getblock_v2_proc_is_ready (proc))
        return;
                                     ...
                                     guint n_procs)
{
    ...
    if (!wingufile_sendblock_v2_proc_is_ready (proc))
        return;
