...
G_DEFINE_TYPE (SeafileGetcsV2Proc, wingufile_getcs_v2_proc, CCNET_TYPE_PROCESSOR)
...
static void
wingufile_getcs_v2_proc_class_init (SeafileGetcsV2ProcClass *klass)
{
...
static void
wingufile_getcs_v2_proc_init (SeafileGetcsV2Proc *processor)
{
}
