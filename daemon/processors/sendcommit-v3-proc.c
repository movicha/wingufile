...
release_resource (CcnetProcessor *processor)
{
    ...
    CCNET_PROCESSOR_CLASS (wingufile_sendcommit_v3_proc_parent_class)->release_resource (processor);
}
...
send_commit_start (CcnetProcessor *processor, int argc, char **argv)
{
    ...
    g_string_printf (buf, "remote %s wingufile-recvcommit-v3 %s %s",
