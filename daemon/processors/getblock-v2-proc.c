...
#define GET_PRIV(o)  \
   (G_TYPE_INSTANCE_GET_PRIVATE ((o), WINGUFILE_TYPE_GETBLOCK_V2_PROC, BlockProcPriv))
...
release_resource (CcnetProcessor *processor)
{
    ...
    CCNET_PROCESSOR_CLASS(wingufile_getblock_v2_proc_parent_class)->release_resource (processor);
}
