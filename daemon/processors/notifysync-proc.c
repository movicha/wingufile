...
release_resource(CcnetProcessor *processor)
{
    ...
    CCNET_PROCESSOR_CLASS (wingufile_notifysync_proc_parent_class)->release_resource (processor);
}
...
wingufile_notifysync_proc_class_init (WingufileNotifysyncProcClass *klass)
{
    ...
    proc_class->name = "wingufile-notifysync";
...
start (CcnetProcessor *processor, int argc, char **argv)
{
    ...
    snprintf (buf, 256, "remote %s wingufile-notifysync-slave %s %s",
