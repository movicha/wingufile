...
#define WINGUFILE_PUTBLOCK_V2_PROC(obj)                  (G_TYPE_CHECK_INSTANCE_CAST ((obj), WINGUFILE_TYPE_PUTBLOCK_V2_PROC, SeafilePutblockV2Proc))
#define WINGUFILE_IS_PUTBLOCK_V2_PROC(obj)               (G_TYPE_CHECK_INSTANCE_TYPE ((obj), WINGUFILE_TYPE_PUTBLOCK_V2_PROC))
#define WINGUFILE_PUTBLOCK_V2_PROC_CLASS(klass)          (G_TYPE_CHECK_CLASS_CAST ((klass), WINGUFILE_TYPE_PUTBLOCK_V2_PROC, SeafilePutblockV2ProcClass))
#define IS_WINGUFILE_PUTBLOCK_V2_PROC_CLASS(klass)       (G_TYPE_CHECK_CLASS_TYPE ((klass), WINGUFILE_TYPE_PUTBLOCK_V2_PROC))
#define WINGUFILE_PUTBLOCK_V2_PROC_GET_CLASS(obj)        (G_TYPE_INSTANCE_GET_CLASS ((obj), WINGUFILE_TYPE_PUTBLOCK_V2_PROC, SeafilePutblockV2ProcClass))
