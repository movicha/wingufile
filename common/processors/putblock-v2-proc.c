...
#define GET_PRIV(o)  \
   (G_TYPE_INSTANCE_GET_PRIVATE ((o), WINGUFILE_TYPE_PUTBLOCK_V2_PROC, BlockProcPriv))
...
block_proc_start (CcnetProcessor *processor, int argc, char **argv)
{
    ...
    prepare_thread_data(processor, send_blocks, put_block_cb);
...
release_resource (CcnetProcessor *processor)
{
    ...
    CCNET_PROCESSOR_CLASS(wingufile_putblock_v2_proc_parent_class)->release_resource (processor);
}
