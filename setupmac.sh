...
while [ $# -ge 1 ]; do
  case $1 in
    "web" )
      ...
      pushd gui/mac/wingufile
      rm -rf wingufileweb.app
      cp -rf ${top_dir}/web/dist/wingufileweb.app wingufileweb.app
      popd
      ;;
    ...
    "10.7" )
      echo "build wingufile.app for Mac OS X 10.7"
      pushd gui/mac/wingufile
      rm -rf build
      xcodebuild -target wingufile-release
      rm -rf ${top_dir}/../wingufile-${VERSION}/wingufile.app
      cp -rf build/Release/wingufile.app ${top_dir}/../wingufile-${VERSION}/wingufile.app
      popd
      ;;

    "10.6" )
      echo "build wingufile.app for Mac OS X 10.6"
      pushd gui/mac/wingufile
      rm -rf build
      xcodebuild -target wingufile-10.6
      rm -rf ${top_dir}/../wingufile-${VERSION}/wingufile.app
      cp -rf build/Release/wingufile.app ${top_dir}/../wingufile-${VERSION}/wingufile.app
      popd
      ;;
