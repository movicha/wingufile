...
create_applet_window ()
{
    ...
    wcex.lpszClassName  = "wingufile-applet";
    wcex.hIcon          = LoadIcon(applet->hInstance, MAKEINTRESOURCE(IDI_WINGUFILE_ICON));

    RegisterClassEx(&wcex);
    applet->hWnd = CreateWindow("wingufile-applet", "wingufile-applet",
