...
#define SEAHUB_OFFICIAL_REGISTER_ADDR "http://cloud.wingufile.com.cn/accounts/register"

#define SEAF_HTTP_ADDR "http://127.0.0.1:13420"
#define WINGUFILE_WEBSITE "http://www.wingufile.com/"

void applet_exit (int code);
int wingufile_applet_start (int argc, char **argv);
