#ifndef WINGUFILE_APPLET_H
#define WINGUFILE_APPLET_H
...
struct _WingufileApplet {
    ...
    SearpcClient                    *wingufile_rpc_client;
...
int set_wingufile_auto_start(int on);

#ifdef WIN32

int get_wingufile_auto_start (void);
